import {uploadImageOnCloudinary,deleteImageOnCloudinary,getRecentImages} from '../service/multimageService.js';
...
export const getRecentImagesHandler  = async (req, res) => {
    const { empid } = req.query;
  
    try {
      const recentImages = await getRecentImages(empid);
